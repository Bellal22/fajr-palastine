...
<body>
    ...
    <div class="container">
        ...
        <p>
            وانطلاقاً من واجب الجمعية و حرصها على تقديم خدماتها لأبناء شعبها الصامد قامت بإعداد نظام تسجيل للوصول السريع لكافة المواطنين و استهدافهم في خطة العمل الإغاثية الحالية.
        </p>

        <p class="styled-text">
            يمكنكم الآن التسجيل وتحديث بياناتكم وتقديم الشكاوي عن طريق هذا النظام بعد التحقق من صحة رقم الهوية🤗
        </p>
