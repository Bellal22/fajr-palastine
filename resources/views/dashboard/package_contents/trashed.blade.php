<x-layout :title="trans('package_contents.trashed')" :breadcrumbs="['dashboard.package_contents.trashed']">
    ...
    @component('dashboard::components.table-box')
        ...
        <tr>
          <th colspan="100">
            <x-check-all-force-delete
                    ...
                    :resource="trans('package_contents.plural')"></x-check-all-force-delete>
            <x-check-all-restore
                    type="{{ \App\Models\PackageContent::class }}"
                    :resource="trans('package_contents.plural')"></x-check-all-restore>
          </th>
        </tr>
        <tr>
        ...
        @forelse($package_contents as $package_content)
            <tr>
                ...
                <td>
                    <a href="{{ route('dashboard.package_contents.trashed.show', $package_content) }}"
