<x-layout :title="trans('people.plural')" :breadcrumbs="['dashboard.people.index']">
        ...
        @component('dashboard::components.table-box')
            ...
            <thead>
                ...
                <tr class="bg-light">
                    ...
                    <th>
                        <i class="fas fa-map-marker-alt"></i> @lang('people.attributes.city')
                    </th>
                    <th>
                    ...
                    <th>
                        <i class="fas fa-user-check"></i> @lang('people.attributes.relatives_count') (المسجل)
                    </th>
                </tr>
            </thead>
            ...
            <tbody>
                @forelse($people as $person)
                    <tr class="align-middle">
                        ...
                        <td class="text-center">
                            @if($person->family_members_count)
    ...
    @else
        ...
        <div class="alert alert-info text-center py-5">
            <i class="fas fa-search fa-3x mb-3 d-block text-info"></i>
            <h4>@lang('people.messages.search_placeholder')</h4>
            <p class="mb-0 text-muted">@lang('people.messages.empty_search')</p>
        </div>
    @endif
</x-layout>
