<x-layout :title="trans('outbound_shipment_items.trashed')" :breadcrumbs="['dashboard.outbound_shipment_items.trashed']">
    ...
    @component('dashboard::components.table-box')
        ...
        <tr>
          <th colspan="100">
            <x-check-all-force-delete
                    ...
                    :resource="trans('outbound_shipment_items.plural')"></x-check-all-force-delete>
            <x-check-all-restore
                    type="{{ \App\Models\OutboundShipmentItem::class }}"
                    :resource="trans('outbound_shipment_items.plural')"></x-check-all-restore>
          </th>
        </tr>
        <tr>
        ...
        @forelse($outbound_shipment_items as $outbound_shipment_item)
            <tr>
                ...
                <td>
                    <a href="{{ route('dashboard.outbound_shipment_items.trashed.show', $outbound_shipment_item) }}"
