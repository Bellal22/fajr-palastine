            ...
            @component('dashboard::components.box')
                ...
                <form action="{{ route('dashboard.projects.beneficiaries.import.store', $project) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="alert alert-info">
                        ...
                        <ul class="mb-0">
                            <li>يجب أن يحتوي الملف على رقم الهوية في العمود الأول</li>
                            <li>حالة الاستلام في العمود التاسع</li>
                            <li>الملاحظات في العمود العاشر</li>
                            <li>تاريخ التسليم في العمود الحادي عشر</li>
                        </ul>
                    </div>
